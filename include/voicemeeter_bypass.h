...
#define VOICEMEETER_BANANA_VERSION "3.1.1.9"
...
#define VOICEMEETER64_BREAKPOINT_RELATIVE_ADDRESS 0x94CAB
#define VOICEMEETER64_CLICK_FUNCTION_BREAKPOINT_OFFSET 0x1840A4
